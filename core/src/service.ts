...
type ServiceMap = Map<ControllerType<any, any, any> | ServiceType<any>, Record<string | number | symbol, ServiceType<any>>>;
type ReadonlyServiceMap = ReadonlyMap<ControllerType<any, any, any> | ServiceType<any>, Record<string | number | symbol, ServiceType<any>>>;
...
export abstract class Service {
	...
	public static readonly register = (target: ControllerType<any, any, any> | ServiceType<any>, key: string | number | symbol, service: ServiceType<any>) => {
